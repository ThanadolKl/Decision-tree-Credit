...
> เมื่อลองเปรียบเทียบลักษณะของ Tree ในค่า Cp ที่แตกต่างกันพบว่า ค่า Cp = 0.001 ซึ่งละเอียดที่สุดก็จะได้ดังรูปที่ 1 (file: DT_0.001) ค่า Cp = 0.01 ก็จะละเอียดน้อยลงมาดังรูปที่ 2 (file: DT_0.01) และค่า Cp = 0.6 ซึ่งเป็นค่าก่อนที่ cp =0.7 ซึ่งจะไม่มีลักษณะของ Decision tree ก็จะได้ดังรูปที่ 3 (file: DT_0.6)
